...
export const metadata = {
  title: 'Sign Up — TaskPad',
  description: 'Create your free TaskPad workspace with scheduled background reminders.',
};
  ...
  return (
    <div className="min-h-screen w-full liquid-glass-bg relative overflow-hidden flex flex-col items-center justify-center p-4 sm:p-6 font-sans selection:bg-blue-500 selection:text-white">
      ...
      <div className="w-full max-w-md flex items-center justify-between mb-4 z-10">
        ...
        <span className="text-[10px] px-2.5 py-0.5 rounded-full bg-emerald-100 dark:bg-emerald-950/80 text-emerald-700 dark:text-emerald-300 font-bold uppercase tracking-wider">
          Free Forever
        </span>
      </div>
      ...
      <div className="w-full max-w-md flex flex-col items-center z-10">
        ...
        <div className="flex flex-col items-center mb-6 text-center">
          ...
          <p className="text-xs text-slate-600 dark:text-slate-400 font-medium mt-1">
            Start organizing your tasks with automated background server alerts.
          </p>
        </div>
